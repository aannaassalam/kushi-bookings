...
function BookingsFilter() {
  ...
  return (
    <div
      className={cx(
        "w-full bg-white grid grid-cols-5 rounded-lg shadow-custom mt-8 border border-gray-200"
      )}
    >
      <HStack className="p-3 border-r border-r-gray-200 min-w-[200px] col-span-3">
        <Box>
      ...
      <HStack
        className="p-3 border-r border-r-gray-200 min-w-[200px] cursor-pointer"
