...
export default function Quote() {
  return (
    <div className="mt-10 relative min-h-[170px] flex flex-col items-center justify-center py-8 max-lg:px-[20px]">
      <Image
      ...
      <p className=" text-white text-lg max-w-[900px] relative z-20 text-center font-semibold  max-md:text-base">
